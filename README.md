# Project EasyLife-test-task
REST API for control users and their transactions. The application supports user registration, role-based authorization and management of records in database using admin panel.  
...
### Clone repository
```console
git clone https://github.com/AlexanderGolDeluxe/easylife-test-task
```
